 ...
 * @returns {any}
 */
export function parse_csv(csv_content) {
 ...
 */
export function get_column_values(csv_content, column_name) {
    const ptr0 = passStringToWasm0(csv_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(column_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_column_values(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @returns {any}
 */
export function calculate_stats(values) {
 ...
 * @returns {any}
 */
export function linear_regression(x_values, y_values) {
 ...
 * @returns {any}
 */
export function analyze_data(x_col, y_column, csv_content) {
    const ptr0 = passStringToWasm0(x_col, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(y_column, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(csv_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.analyze_data(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rust_wasm_csv_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
